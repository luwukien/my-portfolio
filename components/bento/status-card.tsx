...
const REGIONS = [
  { name: "DEEP LEARNING", status: "ACTIVE", latency: "95% competency" },
  { name: "LLM & GENAI", status: "ACTIVE", latency: "90% competency" },
  { name: "NLP", status: "ACTIVE", latency: "88% competency" },
  { name: "COMPUTER VISION", status: "ACTIVE", latency: "85% competency" },
]
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col p-4 gap-0">
        ...
        <div className="grid grid-cols-3 gap-2 border-b border-border pb-2 mb-2">
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground">Field</span>
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground">Status</span>
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground text-right">Proficiency</span>
        </div>
        {REGIONS.map((region) => (
          <div
            key={region.name}
          ...
          >
            <span className="text-[11px] font-mono text-foreground">{region.name}</span>
        ...
        <div className="mt-auto pt-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-[9px] font-mono text-foreground">90%</span>
          </div>
