  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="3rd" label="FPT Univ Year" delay={500} />
        <ScrambleNumber target="3.45" label="Cumulative GPA" delay={800} />
        <ScrambleNumber target="12+" label="AI Projects Built" delay={1100} />
        <ScrambleNumber target="98.2%" label="Avg Model Accuracy" delay={1400} />
      </div>
    </div>
  )
}
