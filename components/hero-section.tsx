...
import { DualFocusGraphic } from "@/components/dual-focus-graphic"
  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        {/* Top headline: AI ENGINEERING -- Geist Pixel Grid */}
        <motion.h1
        ...
        {/* Bottom headline: PYTHON DEVELOPMENT -- Geist Pixel Grid */}
        <motion.h1
          initial={{ opacity: 0, y: 30, filter: "blur(8px)" }}
          animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          transition={{ duration: 0.7, delay: 0.25, ease }}
          className="font-pixel text-4xl sm:text-5xl lg:text-6xl xl:text-7xl tracking-tight text-foreground mb-4 select-none"
          aria-hidden="true"
        >
          luwukien.
        </motion.h1>
