...
/* ── stat block ── */
const STATS = [
  { label: "ACADEMIC_YEAR", value: "2rd Year" },
  { label: "AI_MODELS_BUILT", value: "12+" },
  { label: "GITHUB_COMMITS", value: "850+" },
  { label: "GPA_CLASSIFICATION", value: "Excellent" },
]
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <br />
                <span className="text-[#ea580c]">machine intelligence</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  I am a 2rd-year Software Engineering student specializing in AI at FPT University. I focus on bridging the gap between raw machine learning research and production-grade software. I build systems that are inspectable, scalable, and brutally fast.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  My goal is to learn and contribute to distributed AI systems, large language model optimization, and edge inference architecture. I love diving deep into low-level runtime details and optimizing GPU workloads.
                </p>
              </motion.div>
